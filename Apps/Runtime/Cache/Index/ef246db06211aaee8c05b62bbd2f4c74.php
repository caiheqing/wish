...
<script type="text/javascript">
    var handleUrl="<?php echo U('ajaxhandle');?>";
</script>
</head>
<body>
	<div id='top'>
	...
	<div id='main'>
            <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><dl class='paper a<?php echo mt_rand(1,5);?>'>
			<dt>
				<span class='username'><?php echo ($user["username"]); ?></span>
				<span class='num'>No.<?php echo ($user["uid"]); ?></span>
			</dt>
			<dd class='content'><?php echo ($user["content"]); ?></dd>
			<dd class='bottom'>
				<span class='time'><?php echo (date('Y-m-d',$user["time"])); ?></span>
...
<form action="<?php echo U('ajaxhandle');?>" name='wish' method="post">
        <p>
