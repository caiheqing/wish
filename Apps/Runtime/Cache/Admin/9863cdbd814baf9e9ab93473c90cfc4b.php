...
<head>
<link rel="stylesheet" href="/./Apps/Admin/View/Public/Css/login.css" />
<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
<script type="text/javascript" src="/./Apps/Admin/View/Public/Js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="/./Apps/Admin/View/Public/Js/login.js"></script>
<script type='text/javascript'>
    var URL="<?php echo U('verify');?>?";
        ...
        <body>
                ...
                <div class="login">	
                        <form action="/index.php/Admin/Login/index" method="post" id="login">
                        <div class="title">
                                后盾网 | 登录后台
                        </div>
                        <table border="1" width="100%">
                                ...
                                <tr>
                                        ...
                                        <td>
                                                ...
                                                <img src="<?php echo U('verify');?>" id="code"/> <a href="javascript:void(change_code(this));">看不清</a>
                                        </td>
                                </tr>
                            <tr>
                                <th></th>
